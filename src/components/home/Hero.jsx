    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-950 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
        ...
        <div className="text-center lg:text-left order-2 lg:order-1">
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 text-shadow-md leading-tight">
            Tu sitio web, sin plantillas, sin límites
          </h1>
          <p className="mt-4 sm:mt-6 text-lg md:text-xl lg:text-2xl text-neutral-100 max-w-2xl mx-auto lg:mx-0">
