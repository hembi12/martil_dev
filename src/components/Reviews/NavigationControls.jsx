...
const NavigationControls = ({
  ...
  return (
    <>
      ...
      <button
        onClick={onPrevious}
        className="absolute left-4 top-93 sm:top-33 md:top-33 lg:top-40 -translate-y-1/2 w-10 h-10 bg-white shadow-md rounded-lg hover:scale-110  flex items-center justify-center hover:bg-blue-50 transition-all duration-300 z-10 cursor-pointer"
      ...
      <button
        onClick={onNext}
        className="absolute right-4 top-93 sm:top-33 md:top-33 lg:top-40 -translate-y-1/2 w-10 h-10 bg-white shadow-md rounded-lg hover:scale-110  flex items-center justify-center hover:bg-blue-50 transition-all duration-300 z-10 cursor-pointer"
