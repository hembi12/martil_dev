...
const NavigationControls = ({
  ...
  return (
    <>
      ...
      <button
        onClick={onPrevious}
        className="absolute left-4 top-73 -translate-y-1/2 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center hover:bg-blue-50 transition-colors duration-200 z-10 cursor-pointer"
      ...
      <button
        onClick={onNext}
        className="absolute right-4 top-73 -translate-y-1/2 w-10 h-10 bg-white shadow-lg rounded-full flex items-center justify-center hover:bg-blue-50 transition-colors duration-200 z-10 cursor-pointer"
